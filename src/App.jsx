        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div className="animate-fade-in-up">
            ...
            <p className="text-green-100 mb-12 max-w-2xl mx-auto">
              ...
              excepcionales usando las últimas tecnologías web
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 font-mono text-green-200">
              ...
              <p className="leading-relaxed">
                ...
                especializo en crear aplicaciones robustas y escalables. Mi
                pasión por la tecnología me impulsa a estar siempre al día con
                las últimas tendencias del desarrollo.
              </p>
              <p className="leading-relaxed">
                He trabajado con startups y empresas consolidadas, ayudándolas a
                digitalizar sus procesos y crear productos que impactan
                positivamente en sus usuarios.
              </p>
      ...
      <section id="skills" className="py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {["Frontend", "Backend", "Cloud & DevOps", "Herramientas"].map(
              (title, idx) => (
                <div
                  key={idx}
                  className="bg-black/70 border border-green-500 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow font-mono text-green-200"
                >
      ...
      <section id="projects" className="py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {["SaaS Dashboard", "E-commerce Mobile", "AI Analytics Tool"].map(
              (proj, idx) => (
                <div
                  key={idx}
                  className="group bg-black/70 border border-green-500 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 font-mono text-green-200"
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="mb-4">
                      Descripción del proyecto {proj} en estilo terminal.
                    </p>
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-green-200 mb-12 max-w-2xl mx-auto">
            Estoy disponible para colaborar en proyectos emocionantes. Hablemos
            sobre cómo puedo ayudarte a hacer realidad tu visión digital.
          </p>
